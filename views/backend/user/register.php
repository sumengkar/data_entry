			...
			<div class="card-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<?php echo form_open('user/register', 'class="form"');?>
							<div class="form-group <?php if (form_error("username")) { echo 'has-error';  } ?>">
								<label for="email">Email</label>
								<input name="email" value="<?php echo set_value('email'); ?>" class="form-control" id="email" type="text" >
							...
							<div class="form-group <?php if (form_error("password")) { echo 'has-error';  } ?>">
								...
								<p class="help-block text-right"><a href="<?php echo site_url('user/login') ?>">Sudah Punya Akun?</a></p>
							...
							<div class="row">
								...
								<div class="col-xs-6 text-right">
									<button class="btn btn-primary btn-raised" type="submit">Daftar</button>
								</div>
							</div>
						<?php echo form_close();?>
					</div>
